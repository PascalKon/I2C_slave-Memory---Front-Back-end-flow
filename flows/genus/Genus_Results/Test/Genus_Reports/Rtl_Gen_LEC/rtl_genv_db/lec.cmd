...
REAd DEsign -verilog95 -revised -lastmod -noelab gen.v
...
SET SYstem Mode lec
WRIte COmpared Points noneq.compared_points.I2CAndMemory.rtl.genv.tcl -class noneq -tclmode -replace
...
SET SYstem Mode lec
ANAlyze RESults -logfiles rtl_gen.lec.log
EXIt -f
