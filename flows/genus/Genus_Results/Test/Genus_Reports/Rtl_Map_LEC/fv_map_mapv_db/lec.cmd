...
ADD SEarch Path /mnt/apps/prebuilt/eda/designkits/xfab/XKIT/x_all/cadence/XFAB_AMS_RefKit-cadence_IC61/v2_5_1/pdk/xh018/diglibs/D_CELLS_HD/v3_0/liberty_LPMOS/v3_0_0/PVT_1_80V_range/\
   ...
   -library -both
REAd LIbrary -liberty -both /mnt/apps/prebuilt/eda/designkits/xfab/XKIT/x_all/cadence/XFAB_AMS_RefKit-cadence_IC61/v2_5_1/pdk/xh018/diglibs/D_CELLS_HD/v3_0/liberty_LPMOS/v3_0_0/PVT_1_80V_range/D_CELLS_HD_LPMOS_fast_1_98V_m40C.lib\
...
REAd DEsign -verilog95 -golden -lastmod -noelab /home/p/paschalk/Desktop/I2C_Memory/flows/genus/Genus_Results/Test/Genus_Reports/fv/fv_map.v.gz
ELAborate DEsign -golden -root I2CAndMemory
REAd DEsign -verilog95 -revised -lastmod -noelab map.v
...
ADD PIn Constraints 0 se -golden
...
REPort STatistics
WRIte COmpared Points noneq.compared_points.I2CAndMemory.fv_map.mapv.tcl -class noneq -tclmode -replace
...
REAd DEsign -verilog95 -revised -lastmod -noelab /home/p/paschalk/Desktop/I2C_Memory/flows/genus/Genus_Results/Test/Genus_Reports/fv/fv_map.v.gz
ELAborate DEsign -revised -root I2CAndMemory
...
CHEck VErification Information
SET ANalyze Option -auto -report_map
WRIte HIer_compare Dofile hier_tmp4.lec.do -verbose -noexact_pin_match -constraint -usage -replace -balanced_extraction\
...
RUN HIer_compare hier_tmp4.lec.do -dynamic_hierarchy
REPort HIer_compare Result -dynamicflattened
REPort VErification -hier -verbose
SET SYstem Mode lec
WRIte COmpared Points noneq.compared_points.I2CAndMemory.rtl.fv_map.tcl -class noneq -tclmode -replace
ANAlyze NOnequivalent -source_diagnosis
REPort NOnequivalent Analysis
REPort TEst Vector -noneq
...
REPort IMplementation Information
SET SYstem Mode lec
ANAlyze RESults -logfiles rtl_map.lec.log
EXIt -f
