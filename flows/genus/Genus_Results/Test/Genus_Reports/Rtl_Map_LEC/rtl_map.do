...
# Generated by Genus(TM) Synthesis Solution 22.13-s093_1, revision 1.568.1
# Generated on: Sun Nov 30 21:03:08 EET 2025 (Sun Nov 30 19:03:08 UTC 2025)
...
read_implementation_information /home/p/paschalk/Desktop/I2C_Memory/flows/genus/Genus_Results/Test/Genus_Reports/fv/ -golden fv_map -revised mapv
...
set env(RC_VERSION)     "22.13-s093_1"
set env(CDN_SYNTH_ROOT) "/mnt/apps/prebuilt/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86"
set CDN_SYNTH_ROOT      "/mnt/apps/prebuilt/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86"
set env(CW_DIR) "/mnt/apps/prebuilt/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86/lib/chipware"
set CW_DIR      "/mnt/apps/prebuilt/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86/lib/chipware"
...
read_design -verilog95   -golden -lastmod -noelab /home/p/paschalk/Desktop/I2C_Memory/flows/genus/Genus_Results/Test/Genus_Reports/fv/fv_map.v.gz
elaborate_design -golden -root {I2CAndMemory}

read_design -verilog95   -revised -lastmod -noelab map.v
elaborate_design -revised -root {I2CAndMemory}

#add_name_alias /home/p/paschalk/Desktop/I2C_Memory/flows/genus/Genus_Results/Test/Genus_Reports/fv/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias /home/p/paschalk/Desktop/I2C_Memory/flows/genus/Genus_Results/Test/Genus_Reports/fv/mapv.singlebit.original_name.alias.json.gz -revised
...
#  2      test_mode                      test_mode        true       false       port        none                       true                  true          auto       
#  3      rst_n                          test_mode        false      false       port        none                       false                 false         auto       
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
...
write_compared_points noneq.compared_points.I2CAndMemory.fv_map.mapv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.I2CAndMemory.fv_map.mapv.rpt
}
report_test_vector -noneq > noneq.test_vector.I2CAndMemory.fv_map.mapv.rpt
...
read_implementation_information /home/p/paschalk/Desktop/I2C_Memory/flows/genus/Genus_Results/Test/Genus_Reports/fv/ -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /home/p/paschalk/Desktop/I2C_Memory/I2C_Memory_UVM/src/I2C_Memory.sv /home/p/paschalk/Desktop/I2C_Memory/I2C_Memory_UVM/src/I2C_Slave.sv /home/p/paschalk/Desktop/I2C_Memory/I2C_Memory_UVM/src/Memory.sv
elaborate_design -golden -root {I2CAndMemory} -rootonly 

read_design -verilog95   -revised -lastmod -noelab /home/p/paschalk/Desktop/I2C_Memory/flows/genus/Genus_Results/Test/Genus_Reports/fv/fv_map.v.gz
elaborate_design -revised -root {I2CAndMemory}
...
#add_name_alias /home/p/paschalk/Desktop/I2C_Memory/flows/genus/Genus_Results/Test/Genus_Reports/fv/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
write_hier_compare_dofile hier_tmp4.lec.do -verbose -noexact_pin_match -constraint -usage \
...
run_hier_compare hier_tmp4.lec.do -dynamic_hierarchy
...
set_system_mode lec
write_compared_points noneq.compared_points.I2CAndMemory.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.I2CAndMemory.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.I2CAndMemory.rtl.fv_map.rpt
